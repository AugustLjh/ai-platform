...
from ai_runtime.core.services.document_service import DuplicateDocumentError
...
from ai_runtime.core.quota import QuotaError, convert_quota_error_to_http_exception
