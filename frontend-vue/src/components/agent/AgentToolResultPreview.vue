<template>
  <div v-if="artifactCount > 0" class="tool-preview">
    <article v-for="artifact in answerArtifacts" :key="artifact.id || artifact.name" class="preview-card">
    ...
    <article v-for="artifact in tableArtifacts" :key="artifact.id || artifact.name" class="preview-card">
      <div class="preview-head">
    ...
    <article v-for="artifact in citationArtifacts" :key="artifact.id || artifact.name" class="preview-card">
      <div class="preview-head">
    ...
    <article v-for="artifact in excerptArtifacts" :key="artifact.id || artifact.name" class="preview-card">
      <div class="preview-head">
    ...
    <article v-for="artifact in codeFileArtifacts" :key="artifact.id || artifact.name" class="preview-card">
      <div class="preview-head">
